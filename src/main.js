...
const DEFAULT_BEATS = [
  ...
  { name: 'Sabai & Kiara’s Club', cam: [0, 35, -410], look: [0, 60, -475], up: [0, 1, 0], fov: 68, dur: 1.35, desc: 'An offline-first trip companion for a real Thailand journey — and a dachshund-first store brand, built from palette to cart.', img: '/previews/sabai.jpg', img2: '/previews/kiaras-club.jpg', link: 'https://kiaras-club.vercel.app', fx: { bloomStrength: 0.5 }, panel: { pos: [0, 60, -475], size: [70, 44], billboard: false, rot: [0, 0, 0] } },
...
function save() {
  ...
  localStorage.setItem(SAVE_KEY, JSON.stringify({ beats, speed: speedMul, smooth, g, version: 12 }));
}
