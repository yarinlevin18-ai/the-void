...
| Project 3 | Sabai (Thailand trip app) | Offline-first trip companion built for a real Thailand journey — schedule, weather, stays, flights, maps, budget, emergency info, AI assistant. | Next.js 16 · React 19 · Tailwind v4 · Tesseract.js OCR | none (personal app, not deployed) | dark green header `#12291f` · cream `#f4f1ea` · coral accent | `previews/sabai.jpg` — ✅ done (booking refs scrubbed from capture). Replaced LifeRPG in this slot 2026-08-23 (Yarin: "I don't want that project"). |
| Project 4 | Kiara's Club | Dachshund-first pet storefront — brand + shop + cart built from a real palette (sampled from Kiara the dapple dachshund). | Next.js 16 · React 19 · Tailwind v4 · client cart | `https://kiaras-club.vercel.app` (live 2026-08; kiarasclub.com not bought yet) | cream `#faf6ee` · chocolate `#3e2a20` · mustard `#e8b04b` · tan `#c67b45` | `previews/kiaras-club.webp` — ✅ done |
